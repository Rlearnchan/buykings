...
- 로컬 근거: `autopark/sources.xlsx`, `autopark/config/today_misc_sources.json`, `autopark/data/processed/2026-04-30/*`
...
`autopark/data/source-research/YYYY-MM-DD/source-scorecard.json`

집계 문서:

`autopark/docs/source-scorecard-weekly.md`
