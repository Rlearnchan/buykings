...
- 04.29 방송 텍스트 변환본: `autopark/runtime/transcripts/2026-04-29/buykings-0429-transcript.txt`
- 방송 텍스트 분석: `autopark/docs/0429-broadcast-transcript-analysis.md`
...
- `autopark/scripts/parse_earnings_calendar_tickers.py`

입력:

- `autopark/data/processed/YYYY-MM-DD/earnings-calendar-x-posts.json`

출력:

- `autopark/data/processed/YYYY-MM-DD/earnings-calendar-tickers.json`
- `autopark/runtime/notion/YYYY-MM-DD/earnings-calendar-tickers.md`
...
- `autopark/scripts/build_earnings_ticker_drilldown.py`
...
- `autopark/data/processed/2026-04-29/earnings-ticker-drilldown.json`
- `autopark/runtime/notion/2026-04-29/earnings-ticker-drilldown.md`
...
```bash
node autopark/scripts/collect_x_timeline.mjs --dry-run --source-profile earnings --date 2026-04-29 --max-posts 1 --scrolls 0
```
...
- `autopark/scripts/build_market_radar.py`
...
- `autopark/data/processed/2026-04-29/market-radar.json`
- `autopark/runtime/notion/2026-04-29/market-radar.md`
...
- `autopark/scripts/review_dashboard_quality.py`
...
- `autopark/scripts/prepare_finviz_drilldown_capture.py`
...
- `autopark/data/processed/2026-04-29/finviz-drilldown-capture-plan.json`
- `autopark/runtime/notion/2026-04-29/finviz-drilldown-capture-plan.md`
...
- `autopark/scripts/build_side_dish_candidates.py`
...
- `autopark/scripts/build_live_notion_dashboard.py`
...
```bash
autopark/.venv/bin/python autopark/scripts/build_live_notion_dashboard.py --date 2026-04-29 --output /tmp/autopark-0429-dashboard-v2.md
autopark/.venv/bin/python autopark/scripts/review_dashboard_quality.py --date 2026-04-29 --input /tmp/autopark-0429-dashboard-v2.md --json
```
