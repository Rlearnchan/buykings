...
/Users/bae/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin/node autopark/scripts/collect_x_timeline.mjs --date 2026-04-29
autopark/.venv/bin/python autopark/scripts/build_visual_cards.py --date 2026-04-29
...
for chart in us10y crude-oil-wti crude-oil-brent dollar-index usd-krw bitcoin; do
  autopark/.venv/bin/python autopark/scripts/fetch_market_chart_data.py --date 2026-04-29 --chart "$chart" --collected-at "26.04.29 07:00"
done
autopark/.venv/bin/python autopark/scripts/fetch_economic_calendar.py --date 2026-04-29
```

특징주 일봉/Finviz 뉴스 출발점은 별도 캡처로 보강한다.

```bash
/Users/bae/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin/node autopark/scripts/capture_finviz_feature_stocks.mjs --date 2026-04-29
autopark/.venv/bin/python autopark/scripts/build_feature_stock_cards.py --date 2026-04-29
```
...
- `autopark/data/processed/2026-04-29/today-misc-batch-a-candidates.json`
- `autopark/data/processed/2026-04-29/today-misc-batch-b-candidates.json`
- `autopark/data/processed/2026-04-29/today-misc-clusters.json`
- `autopark/data/processed/2026-04-29/storyline-selection-v4.json`
- `autopark/data/processed/2026-04-29/live-experiment-pack.json`
- `autopark/runtime/notion/2026-04-29/live-experiment-pack.md`
...
평가 메모는 `autopark/docs/0429-live-experiment-review.md`에 작성한다.
