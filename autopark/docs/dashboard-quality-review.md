...
```bash
autopark/.venv/bin/python autopark/scripts/review_dashboard_quality.py --date 2026-04-29
```

기본 입력은 `autopark/runtime/notion/YYYY-MM-DD/YY.MM.DD.md`이고, 결과는 아래에 저장된다.

- `autopark/runtime/reviews/YYYY-MM-DD/dashboard-quality.md`
- `autopark/runtime/reviews/YYYY-MM-DD/dashboard-quality.json`
