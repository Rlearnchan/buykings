...
- post timing weekday average
  ...
  - PNG: `exports/wepoll-samsung/next-batch/post-timing-weekday-avg.png`
...
- post timing weekday split
  ...
  - PNG: `exports/wepoll-samsung/next-batch/post-timing-weekday-yearsplit.png`
...
- member semantic periods
  - status: draft ready
  - asset: `exports/wepoll-samsung/semantic-periods/member-word2vec-period-pca.svg`
  - note: `2025 / 2026 / 이벤트주간` 기준 주요 단어 약 50개 PCA와 멤버별 similar 5개 표를 생성했다
  - report: `projects/wepoll-samsung/notes/member-word2vec-periods.md`
  - review csv: `projects/wepoll-samsung/prepared/dw_member_word2vec_candidate_dots.csv`
  - table csv: `projects/wepoll-samsung/prepared/dw_member_word2vec_similar_table.csv`
...
- member semantic scatter
  ...
  - 2025 PNG: `exports/wepoll-samsung/semantic-periods/word2vec-2025.png`
  - 2026 chart id: `nI7xI`
  - 2026 public url: `https://datawrapper.dwcdn.net/nI7xI/1/`
  - 2026 PNG: `exports/wepoll-samsung/semantic-periods/word2vec-2026.png`
  - 이벤트주간 chart id: `u08tZ`
  - 이벤트주간 public url: `https://datawrapper.dwcdn.net/u08tZ/1/`
  - 이벤트주간 PNG: `exports/wepoll-samsung/semantic-periods/word2vec-eventweek.png`
  - note: 2025 / 2026 / 이벤트주간 3시기 scatter를 모두 발행했다

- member similar table
  - chart id: `Q1Xdw`
  - public url: `https://datawrapper.dwcdn.net/Q1Xdw/1/`
  - PNG: `exports/wepoll-samsung/semantic-periods/word2vec-similar-table.png`
...
- fightin words overall table
  ...
  - PNG: `exports/wepoll-samsung/semantic-periods/fightin-words-overall-table.png`
