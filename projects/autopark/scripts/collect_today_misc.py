                ...
                refs.append(
                    {
                        **image,
                        "download_status": "ok",
                        "local_path": str(final_path.relative_to(PROJECT_ROOT.parents[1])),
...
def main() -> int:
    ...
    payload = {
        ...
        "assets_path": str(assets_dir.relative_to(PROJECT_ROOT.parents[1])) if not args.no_download_images else None,
