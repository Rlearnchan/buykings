    ...
    def test_quality_gate_allows_blank_fedwatch_card(self) -> None:
        markdown = "\n".join(
            [
                ...
                "",
                "**왜 중요한가**",
                "- 전날 시장은 유가와 인플레를 함께 봤다.",
                "- 한국장 에너지와 물가 민감주 연결점이 있다.",
                "",
                "**슬라이드 구성:** `② 유가 기사`",
                "### 3. 실적 변수 확인",
                "추천도: `★★☆`",
                ...
                "### 주요 지수 흐름",
                "- 출처: [Finviz](https://finviz.com/)",
                "- 수집 시점: `26.05.04 05:10`",
                "![주요 지수 흐름](a.png)",
                "![주요 지수 흐름](b.png)",
                "### S&P500 히트맵",
                "- 출처: [Finviz](https://finviz.com/map.ashx?t=sec)",
                "- 수집 시점: `26.05.04 05:10`",
                "![S&P500 히트맵](sp500.png)",
                "### 러셀 2000 히트맵",
                "- 출처: [Finviz](https://finviz.com/map?t=sec_rut)",
                "- 수집 시점: `26.05.04 05:10`",
                "![러셀 2000 히트맵](rut.png)",
                "### 10년물 국채금리",
                ...
                "![비트코인 가격 차트](btc.png)",
                "### CNN Fear & Greed",
                "- 출처: [CNN](https://www.cnn.com/markets/fear-and-greed)",
                "- 수집 시점: `26.05.04 05:10`",
                "- 이미지 없음",
                "### FedWatch",
                "- 출처: [CME FedWatch](https://www.cmegroup.com/markets/interest-rates/cme-fedwatch-tool.html)",
                "- 수집 시점: `26.05.04 05:10`",
                "- 이미지 없음",
                "### 오늘의 경제지표",
