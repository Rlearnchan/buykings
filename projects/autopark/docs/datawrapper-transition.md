...
```text
projects/autopark/runtime/screenshots/YYYY-MM-DD/
projects/autopark/data/raw/YYYY-MM-DD/
```
...
`projects/autopark/charts/`에 chart spec을 만들고,
`projects/autopark/prepared/`에 prepared CSV를 생성한다.
...
python3 scripts/datawrapper_publish.py projects/autopark/charts/us10y-datawrapper.json
python3 scripts/datawrapper_export_png.py <chart_id> projects/autopark/exports/current/us10y.png
```
...
- `projects/autopark/prepared/us10y-2026-04-28.csv`
- `projects/autopark/charts/us10y-datawrapper.json`
- `projects/autopark/data/raw/2026-04-28/us10y-market-data.json`
- `projects/autopark/prepared/crude-oil-2026-04-28.csv`
- `projects/autopark/charts/crude-oil-datawrapper.json`
- `projects/autopark/data/raw/2026-04-28/crude-oil-market-data.json`
...
- `scripts/datawrapper_publish.py --dry-run projects/autopark/charts/us10y-datawrapper.json` 정상
- Datawrapper `us10y` chart 생성/게시 정상: `nofn2`
- `projects/autopark/exports/current/us10y.png` PNG export 정상
...
- 2026-04-28에 원유 차트도 FRED-first로 전환했다.
  ...
  - WTI Datawrapper chart id: `TYqZk`, PNG export: `projects/autopark/exports/current/crude-oil-wti.png`
  - Brent Datawrapper chart id: `jZDeO`, PNG export: `projects/autopark/exports/current/crude-oil-brent.png`
- 2026-04-28에 `dollar-index`, `usd-krw`도 FRED-first로 전환했다.
  - FRED series: `DTWEXBGS`, `DEXKOUS`
  - Datawrapper chart ids: `aIYNm`, `tTyEQ`
  - PNG exports: `projects/autopark/exports/current/dollar-index.png`, `projects/autopark/exports/current/usd-krw.png`
...
- 2026-04-28에 `bitcoin`을 CoinGecko-first로 전환했다.
  ...
  - PNG export: `projects/autopark/exports/current/bitcoin.png`
- 2026-04-28에 경제캘린더를 Datawrapper table로 전환했다.
  - source: `https://ko.tradingeconomics.com/calendar?importance=2`
  - parser: `projects/autopark/scripts/fetch_economic_calendar.py`
  - raw HTML: `projects/autopark/data/raw/YYYY-MM-DD/tradingeconomics-calendar-importance2.html`
  - processed JSON: `projects/autopark/data/processed/YYYY-MM-DD/economic-calendar.json`
  - prepared CSV: `projects/autopark/prepared/economic-calendar-YYYY-MM-DD.csv`
  - Datawrapper chart id: `mPSRp`
  - PNG export: `projects/autopark/exports/current/economic-calendar.png`
...
- `projects/autopark/exports/current/us10y.png`
- `projects/autopark/exports/current/crude-oil-wti.png`
- `projects/autopark/exports/current/crude-oil-brent.png`
- `projects/autopark/exports/current/dollar-index.png`
- `projects/autopark/exports/current/usd-krw.png`
- `projects/autopark/exports/current/bitcoin.png`
- `projects/autopark/exports/current/economic-calendar.png`
