...
- 2026-04-28 기준 4/22 전용 재빌드는 `projects/autopark/scripts/rebuild_0422_dashboard.py`로 묶었다. 기본은 로컬 Markdown 생성이고, `--publish`를 붙이면 Notion까지 replace publish한다.
...
- `projects/autopark/` 프로젝트 골격, venv, 실행 스크립트, 문서/산출물 디렉터리 구성 완료
...
8. 서버 이관 전 `projects/autopark/docs/runbook.md` 작성
