...
먼저 `projects/autopark/config/today_misc_sources.json`으로 정규화한다.
...
- `projects/autopark/config/today_misc_sources.json`
...
- `projects/autopark/scripts/import_today_misc_sources.py`
- `projects/autopark/config/today_misc_sources.json`
...
- `projects/autopark/data/raw/2026-04-28/today-misc/cnbc-com-world.json`
- `projects/autopark/data/raw/2026-04-28/today-misc/finance-yahoo-com-source.json`
- `projects/autopark/data/raw/2026-04-28/today-misc/tradingview-com-news.json`
- `projects/autopark/data/processed/2026-04-28/today-misc-candidates.json`
- `projects/autopark/runtime/notion/2026-04-28/today-misc-review.md`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/collect_today_misc.py --date 2026-04-28 --run-name today-misc-batch-a --lookback-hours 24 --require-recent-signal --limit-per-source 8 --overall-limit 24
```

산출물:

- `projects/autopark/data/raw/2026-04-28/today-misc-batch-a/`
- `projects/autopark/data/processed/2026-04-28/today-misc-batch-a-candidates.json`
- `projects/autopark/runtime/notion/2026-04-28/today-misc-batch-a-review.md`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/collect_today_misc.py --date 2026-04-28 --batch-b-default --run-name today-misc-batch-b --lookback-hours 24 --require-recent-signal --limit-per-source 6 --overall-limit 24
```

산출물:

- `projects/autopark/data/raw/2026-04-28/today-misc-batch-b/`
- `projects/autopark/data/processed/2026-04-28/today-misc-batch-b-candidates.json`
- `projects/autopark/runtime/notion/2026-04-28/today-misc-batch-b-review.md`
...
```bash
/Users/bae/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin/node projects/autopark/scripts/collect_x_timeline.mjs --date 2026-04-28 --run-name x-timeline --lookback-hours 24 --max-posts 5 --scrolls 2
```

산출물:

- `projects/autopark/data/raw/2026-04-28/x-timeline/`
- `projects/autopark/data/processed/2026-04-28/x-timeline-posts.json`
- `projects/autopark/runtime/notion/2026-04-28/x-timeline-review.md`
...
- `projects/autopark/scripts/build_today_misc_append.py`
- `projects/autopark/scripts/append_markdown_to_notion.py`
- `projects/autopark/runtime/notion/2026-04-28/today-misc-poc-append.md`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/build_today_misc_append.py --date 2026-04-28
projects/autopark/.venv/bin/python projects/autopark/scripts/append_markdown_to_notion.py projects/autopark/runtime/notion/2026-04-28/today-misc-poc-append.md --page-id 350468fb878d816fa2b5f8fc75487095 --page-id 350468fb878d81a19650e14eb97b6b9d --prepend-heading "오늘의 이모저모 자동 수집 PoC"
```
...
- `collect_today_misc.py`
  ...
  - 연결된 이미지를 `projects/autopark/runtime/assets/YYYY-MM-DD/<run-name>/` 아래에 다운로드
- `collect_x_timeline.mjs`
  - X 게시물 이미지 URL을 `image_refs`로 정규화
  - 이미지를 `projects/autopark/runtime/assets/YYYY-MM-DD/x-timeline/` 아래에 다운로드

현재 저장 결과:

- Isabelnet 이미지: `projects/autopark/runtime/assets/2026-04-28/today-misc-batch-b/`
- X 이미지: `projects/autopark/runtime/assets/2026-04-28/x-timeline/`
...
- `projects/autopark/scripts/caption_visual_assets.py`

입력:

- `projects/autopark/data/processed/YYYY-MM-DD/today-misc-batch-b-candidates.json`
- `projects/autopark/data/processed/YYYY-MM-DD/x-timeline-posts.json`
- 각 후보의 `image_refs[].local_path`

출력:

- `projects/autopark/data/processed/YYYY-MM-DD/image-intel.json`
- `projects/autopark/runtime/notion/YYYY-MM-DD/image-intel-review.md`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/caption_visual_assets.py --date 2026-04-28 --limit 4 --dry-run
```
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/caption_visual_assets.py --date 2026-04-28 --limit 6
```

- 이미지 후보 6개 모두 `status: ok`
- 평균적으로 이미지당 13~17초 소요
- 산출물:
  - `projects/autopark/data/processed/2026-04-28/image-intel.json`
  - `projects/autopark/runtime/notion/2026-04-28/image-intel-review.md`
- 후보 주제:
...
```bash
OPENAI_API_KEY=... projects/autopark/.venv/bin/python projects/autopark/scripts/caption_visual_assets.py --date 2026-04-28 --limit 4
```

또는 상위 `.env`에 `OPENAI_API_KEY`를 추가한 뒤:

```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/caption_visual_assets.py --date 2026-04-28 --limit 4
```
...
- `projects/autopark/scripts/inspect_notion_page.py`
  - Notion example page(`26.04.21`)의 block outline을 읽어 포맷 비교용 JSON으로 저장한다.
- `projects/autopark/scripts/build_storyline_append.py`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/inspect_notion_page.py --max-depth 2 --output projects/autopark/runtime/notion/2026-04-28/notion-0421-sample-outline.json
projects/autopark/.venv/bin/python projects/autopark/scripts/build_storyline_append.py --date 2026-04-28 --sample-outline projects/autopark/runtime/notion/2026-04-28/notion-0421-sample-outline.json --limit-news 10 --limit-x 8 --limit-images 6
projects/autopark/.venv/bin/python projects/autopark/scripts/append_markdown_to_notion.py projects/autopark/runtime/notion/2026-04-28/today-misc-integrated-storylines.md --page-id 350468fb878d816fa2b5f8fc75487095 --page-id 350468fb878d81a19650e14eb97b6b9d --prepend-heading "오늘의 이모저모 통합 스토리라인 PoC" --upload-images
```

산출물:

- `projects/autopark/runtime/notion/2026-04-28/notion-0421-sample-outline.json`
- `projects/autopark/runtime/notion/2026-04-28/today-misc-integrated-storylines.md`
...
- `projects/autopark/scripts/build_visual_cards.py`
...
- `projects/autopark/scripts/select_storylines_v2.py`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/build_visual_cards.py --date 2026-04-28 --fetch-descriptions
projects/autopark/.venv/bin/python projects/autopark/scripts/select_storylines_v2.py --date 2026-04-28 --sample-outline projects/autopark/runtime/notion/2026-04-28/notion-0421-sample-outline.json --selected-count 8 --limit-news 12 --limit-x 8 --limit-visuals 8
```

산출물:

- `projects/autopark/data/processed/2026-04-28/visual-cards.json`
- `projects/autopark/runtime/notion/2026-04-28/visual-cards-review.md`
- `projects/autopark/data/processed/2026-04-28/storyline-selection-v2.json`
- `projects/autopark/runtime/notion/2026-04-28/storyline-selection-v2.md`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/append_markdown_to_notion.py projects/autopark/runtime/notion/2026-04-28/storyline-selection-v2.md --page-id 350468fb878d816fa2b5f8fc75487095 --page-id 350468fb878d81a19650e14eb97b6b9d --prepend-heading "오늘의 이모저모 선별·스토리라인 v2" --upload-images
```
...
- `projects/autopark/scripts/build_clean_recon_with_storyline.py`
  - 기존 `projects/autopark/recon/26.04.22.md`, `projects/autopark/recon/26.04.23.md`를 읽는다.
  - `## 2. 오늘의 이모저모` 섹션을 `storyline-selection-v2.md` 본문으로 교체한다.
  - clean recon 파일을 `projects/autopark/runtime/notion/2026-04-28/clean-recon/` 아래에 만든다.

실행:

```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/build_clean_recon_with_storyline.py projects/autopark/recon/26.04.22.md projects/autopark/recon/26.04.23.md --storyline projects/autopark/runtime/notion/2026-04-28/storyline-selection-v2.md --output-dir projects/autopark/runtime/notion/2026-04-28/clean-recon
projects/autopark/.venv/bin/python projects/autopark/scripts/publish_recon_to_notion.py --replace-existing projects/autopark/runtime/notion/2026-04-28/clean-recon/26.04.22.md projects/autopark/runtime/notion/2026-04-28/clean-recon/26.04.23.md
```
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/build_recon_0421_format.py projects/autopark/recon/26.04.22.md --selection projects/autopark/data/processed/2026-04-28/storyline-selection-v2.json --output projects/autopark/runtime/notion/2026-04-28/0421-format/26.04.22.md
projects/autopark/.venv/bin/python projects/autopark/scripts/publish_recon_to_notion.py --replace-existing projects/autopark/runtime/notion/2026-04-28/0421-format/26.04.22.md
```
...
- `projects/autopark/docs/notion-0421-format-checklist.md`에 구현 가능한 Notion 표기 체크리스트를 작성했다.
- `projects/autopark/scripts/build_recon_0421_format.py`를 보강했다.
...
- `projects/autopark/scripts/cluster_today_misc.py`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/cluster_today_misc.py --date 2026-04-28
projects/autopark/.venv/bin/python projects/autopark/scripts/select_storylines_v3.py --date 2026-04-28 --sample-outline projects/autopark/runtime/notion/2026-04-28/example-0421-outline.json --selected-count 8
projects/autopark/.venv/bin/python projects/autopark/scripts/build_recon_0421_format.py projects/autopark/recon/26.04.22.md --selection projects/autopark/data/processed/2026-04-28/storyline-selection-v3.json --output projects/autopark/runtime/notion/2026-04-28/0421-format-v3/26.04.22.md
projects/autopark/.venv/bin/python projects/autopark/scripts/publish_recon_to_notion.py --replace-existing projects/autopark/runtime/notion/2026-04-28/0421-format-v3/26.04.22.md
```
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/build_feature_stock_cards.py --page-date 26.04.22 --date 2026-04-28
projects/autopark/.venv/bin/python projects/autopark/scripts/build_recon_0421_format.py projects/autopark/recon/26.04.22.md --selection projects/autopark/data/processed/2026-04-28/storyline-selection-v3.json --feature-stocks projects/autopark/runtime/notion/2026-04-28/feature-stock-cards.md --output projects/autopark/runtime/notion/2026-04-28/0421-format-v3/26.04.22.md
projects/autopark/.venv/bin/python projects/autopark/scripts/publish_recon_to_notion.py --replace-existing projects/autopark/runtime/notion/2026-04-28/0421-format-v3/26.04.22.md
```
...
```bash
/Users/bae/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin/node projects/autopark/scripts/capture_finviz_feature_stocks.mjs --date 2026-04-28 --headed --browser-channel chrome
projects/autopark/.venv/bin/python projects/autopark/scripts/build_feature_stock_cards.py --page-date 26.04.22 --date 2026-04-28 --finviz-enrichment projects/autopark/data/processed/2026-04-28/finviz-feature-stocks.json
projects/autopark/.venv/bin/python projects/autopark/scripts/build_recon_0421_format.py projects/autopark/recon/26.04.22.md --selection projects/autopark/data/processed/2026-04-28/storyline-selection-v3.json --feature-stocks projects/autopark/runtime/notion/2026-04-28/feature-stock-cards.md --output projects/autopark/runtime/notion/2026-04-28/0421-format-v3/26.04.22.md
projects/autopark/.venv/bin/python projects/autopark/scripts/publish_recon_to_notion.py --replace-existing projects/autopark/runtime/notion/2026-04-28/0421-format-v3/26.04.22.md
```
...
- `projects/autopark/config/market_charts.json`
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart us10y --source yahoo_finance --range 1y --interval 1d
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart crude-oil-wti --source yahoo_finance --range 1y --interval 1d
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart crude-oil-brent --source yahoo_finance --range 1y --interval 1d
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart dollar-index --source yahoo_finance --range 1y --interval 1d
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart usd-krw --source yahoo_finance --range 1y --interval 1d
projects/autopark/.venv/bin/python projects/autopark/scripts/build_recon_0421_format.py projects/autopark/recon/26.04.22.md --selection projects/autopark/data/processed/2026-04-28/storyline-selection-v3.json --finviz-enrichment projects/autopark/data/processed/2026-04-28/finviz-feature-stocks.json --feature-stocks projects/autopark/runtime/notion/2026-04-28/feature-stock-cards.md --output projects/autopark/runtime/notion/2026-04-28/0421-format-v4/26.04.22.md
projects/autopark/.venv/bin/python projects/autopark/scripts/publish_recon_to_notion.py --replace-existing projects/autopark/runtime/notion/2026-04-28/0421-format-v4/26.04.22.md
```
...
- `projects/autopark/scripts/rebuild_0422_dashboard.py`
...
```bash
projects/autopark/.venv/bin/python -m py_compile projects/autopark/scripts/publish_recon_to_notion.py projects/autopark/scripts/build_recon_0421_format.py projects/autopark/scripts/build_feature_stock_cards.py projects/autopark/scripts/select_storylines_v4.py projects/autopark/scripts/build_visual_cards.py projects/autopark/scripts/caption_visual_assets.py projects/autopark/scripts/rebuild_0422_dashboard.py
projects/autopark/.venv/bin/python projects/autopark/scripts/select_storylines_v4.py --date 2026-04-28 --sample-outline projects/autopark/runtime/notion/2026-04-28/example-0421-outline.json --selected-count 8
projects/autopark/.venv/bin/python projects/autopark/scripts/build_visual_cards.py --date 2026-04-28
projects/autopark/.venv/bin/python projects/autopark/scripts/caption_visual_assets.py --date 2026-04-28 --only-needs-visual-reasoning --dry-run
projects/autopark/.venv/bin/python projects/autopark/scripts/rebuild_0422_dashboard.py
projects/autopark/.venv/bin/python projects/autopark/scripts/publish_recon_to_notion.py --replace-existing projects/autopark/runtime/notion/2026-04-28/0421-format-v4/26.04.22.md
projects/autopark/.venv/bin/python projects/autopark/scripts/inspect_notion_page.py --page-id 350468fb-878d-8117-be36-f2ab11146d11
```
...
```bash
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart us10y --source yahoo_finance --range 1y --interval 1d --collected-at '26.04.28 05:00'
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart crude-oil-wti --source yahoo_finance --range 1y --interval 1d --collected-at '26.04.28 05:00'
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart crude-oil-brent --source yahoo_finance --range 1y --interval 1d --collected-at '26.04.28 05:00'
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart dollar-index --source yahoo_finance --range 1y --interval 1d --collected-at '26.04.28 05:00'
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart usd-krw --source yahoo_finance --range 1y --interval 1d --collected-at '26.04.28 05:00'
projects/autopark/.venv/bin/python projects/autopark/scripts/fetch_market_chart_data.py --date 2026-04-28 --chart bitcoin --source coingecko --range 1y --interval 1d --collected-at '26.04.28 05:00'
projects/autopark/.venv/bin/python projects/autopark/scripts/rebuild_0422_dashboard.py
projects/autopark/.venv/bin/python projects/autopark/scripts/publish_recon_to_notion.py --replace-existing projects/autopark/runtime/notion/2026-04-28/0421-format-v4/26.04.22.md
```
